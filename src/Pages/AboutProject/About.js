...
function About() {
  ...
  useEffect(() => {
    fetch([VARIABLES.fetchBaseUrl, 'content-abouts'].join('/'))
      ...
      .then((data) => {
        ...
        setAboutBanner_card(get('aboutBanner_card'));

        setAboutImgCredit(get('aboutImgCredit'));

        setAboutImgCredit_more(get('aboutImgCredit_more'));

        setAboutTimeline_1(get('aboutTimeline_1'));

        setAboutTimeline_2(get('aboutTimeline_2'));

        setAboutTimeline_3(get('aboutTimeline_3'));

        setAboutTimeline_4(get('aboutTimeline_4'));

        setAboutTimeline_5(get('aboutTimeline_5'));
      });
  }, []);
  ...
  useEffect(() => {
    fetch([VARIABLES.fetchBaseUrl, 'content-about-pdfs'].join('/'))
      ...
      .then((data) => {
        const get = (section) => {
          return getWhere(data, 'Section', section)[0]['pdf'][0]['url'];
        };

        setAboutDocuments_ddlink(get('aboutDocuments_ddlink'));

        setAboutDocuments_cblink(get('aboutDocuments_cblink'));

        setAboutDocuments_frlink(get('aboutDocuments_frlink'));

        setAboutDocuments_aplink(get('aboutDocuments_aplink'));
      })
    ...
    <div className="about">
      ...
      <div className="aboutBanner">
        ...
        <div className="aboutBanner_card">
          <p>{aboutBanner_card}</p>
        </div>
        <div className="aboutBanner_credit" title={aboutImgCredit_more}>
          <p>PHOTO BY {aboutImgCredit}</p>
        </div>
      ...
      <div className="aboutTimeline">
        <div className="aboutTimeline_header">
          <p>PROJECT TIMELINE</p>
        </div>
        <div className="aboutTimeline_annot aboutTimeline_annot1">
          <div className="aboutTimeline_annotNo">
            <p>1</p>
          </div>
      ...
      <div className="aboutDocuments">
        <Link to={`PDFViewer/${aboutDocuments_ddlink.split('/')[2]}`}>
        ...
        <div className="aboutTable_tabs">
          {Object.keys(contributors).map((k) => (
            <div
              ...
              className={`aboutTable_tab ${
                currentTab === k ? 'aboutTable_tab--active' : ''
              }`}
